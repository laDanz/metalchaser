...
/**
 * A utility class to load textures for LWJGL. This source is based on a texture
 * that can be found in the Java Gaming (www.javagaming.org) Wiki.
 * 
...
public class TextureLoader {
	...
	public Texture getTexture(String resourceName) throws IOException {
		...
		if (tex != null) {
			// System.out.println("Texture " + resourceName + " already
			// loaded");
			return tex;
		}
